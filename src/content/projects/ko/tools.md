...
<h1>Overview</h1>
<p>〈Tools〉는 출판 편집자의 업무 편의를 위해 제작된 툴킷 서비스다. 본 서비스는 출판 편집자 커뮤니티인 <a href="https://editorsroom.kr" target="_blank">에디터스 룸</a>의 제안으로 제작되었으며, 해당 커뮤니티의 도움을 받아 현직자들의 실제 목소리와 필요를 충실히 반영했다.</p>
</div>
<br>
<figure class="seamless">
...
<h1>01. 문장 부호 복사기</h1>
<ul>
  <li>핵심 기능: 편집 실무에서 가장 빈도가 높은 9가지 문장 부호를 기본 제공.</li>
  <li>커스텀 설정: 나만의 부호 추가 및 관리(삭제) 가능.</li>
  <li>편의성: 부호의 이름과 용도를 직관적으로 디자인하여 가독성을 높임.</li>
  <li>개인정보 보호: 별도의 회원가입 없이 로컬 스토리지를 활용해 사용자 데이터를 안전하게 저장.</li>
</ul>
</div>
<br>
...
<h1>02. 책등 계산기</h1>
<ul>
  <li>정밀 계산: 종이 종류와 평량(g/㎡), 쪽수를 선택하여 책의 두께를 즉시 확인 가능.</li>
  <li>실무 최적화: 표지 기본값(4쪽) 선입력, 종이별 평량 매칭 기능으로 불필요한 단계를 줄임.</li>
  <li>공유 기능: 계산된 사양을 텍스트로 복사하여 제작처나 디자이너에게 빠르게 전달 가능. </li>
</ul>
</div>
<br>
...
<h1>03. 책 크기 비교표</h1>
<ul>
  <li>인터랙티브 비교: 표 위에 마우스를 올려 여러 판형의 크기를 실시간으로 비교 가능.</li>
  <li>데이터 큐레이션: 판형별 대표 서적의 정보(표지, 작가, 출판사, 규격)를 위계 있게 정리하여 기획 단계의 영감을 제공.</li>
</ul>
</div>
<br>
...
<h1>04. 글자 수 계산기</h1>
<ul>
  <li>다양한 기준: 공백 포함/제외 글자 수, 단어 수는 물론 출판 실무의 핵심인 '원고지 장수' 환산 기능을 제공.</li>
  <li>업무 효율: 입력한 텍스트를 그대로 다시 복사할 수 있어 교정·교열 작업 중에도 끊김 없이 사용 가능.</li>
</ul>
</div>
<br>
<figure class="seamless">
...
<h1>05. QR코드 생성기</h1>
<ul>
  <li>안정성 최우선: 유효기간 제한이나 링크 변조 걱정 없는 안전한 QR코드를 생성.</li>
  <li>전문가용 다운로드: 고해상도 인쇄를 위한 SVG(벡터) 파일과 웹용 PNG 파일을 모두 제공.</li>
  <li>맞춤 가이드: 이미지 확장자가 낯선 편집자를 위해 상황별 추천 툴팁을 배치.</li>
</ul>
</div>
<br>
...
<h1>06. 그 밖의 기능</h1>
<ul>
  <li>교정 부호 사용법: 헷갈리기 쉬운 교정 기호와 용례를 표로 정리해 실무 숙련도를 높임.</li>
  <li>근무/급여 관리: 근무 기간 계산기와 연도별 연봉 실수령액 확인 기능을 통해 경력 관리에 도움을 줌.</li>
  <li>사이트 모음: 편집자가 업무 중 반드시 참고해야 할 유용한 사이트들을 한데 모음.</li>
</ul>
</div>
<br>
<hr>
